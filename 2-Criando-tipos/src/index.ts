...
function nasa(nome: string, coordenadas: number, situacao: string, satelite: number) {
const planet = {
    nome,
    coordenadas,
    situacao,
...
function atualizarSituacao(nomeplaneta: string, novaSituacao: string) {
...
function addSatelite(nomeplaneta: string, satelite: number) {
    const planeta = satelites.find(p => p.nome === nomeplaneta);
...
function removeSatelite(nomeplaneta: string, satelite: number) {
    const planeta = satelites.find(p => p.nome === nomeplaneta);
